...
const PropertyDetailsSale = () => {
    ...
    return (
      <div className="property-page-area pd-top-120 pd-bottom-90 ">
              ...
              <aside className="sidebar-area">
                <div className="widget widget-place">
                  ...
                  <ul>
                    ...
                    <li>
                      Chennai <span>21</span>
                    </li>
                    <li>
                      Gujarat <span>31</span>
                    </li>
                  </ul>
                </div>
        ...
        <div style={{marginTop: 40, display: 'flex', gap: '2rem', flexWrap: 'wrap'}}>
          <div style={{flex: 1, minWidth: 220, background: '#f3eaff', borderRadius: 12, padding: 24}}>
            <h5 style={{color: '#8000ff'}}>Walkability Score</h5>
            <p style={{fontSize: '1.1rem'}}>7/10 (Mocked for demo)</p>
          </div>
          <div style={{flex: 1, minWidth: 220, background: '#f3eaff', borderRadius: 12, padding: 24}}>
            <h5 style={{color: '#8000ff'}}>Live Chat</h5>
            <p style={{fontSize: '1.1rem'}}>Chat feature coming soon!</p>
          </div>
          <div style={{flex: 1, minWidth: 220, background: '#f3eaff', borderRadius: 12, padding: 24}}>
            <h5 style={{color: '#8000ff'}}>Encrypted Reviews</h5>
            <p style={{fontSize: '1.1rem'}}>Secure property reviews coming soon!</p>
          </div>
        </div>
      </div>
    );
