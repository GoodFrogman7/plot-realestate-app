			            ...
			            <div className="item">
			              <div className="single-testimonial-inner style-two text-center">
			                ...
			                <div className="details">
			                  ...
			                  <p>“Plot made it so easy to find a verified flat in Mumbai. The support team was fantastic!”</p>
			                  <h6>Priya S., Mumbai</h6>
			            ...
			            <div className="item">
			              <div className="single-testimonial-inner style-two text-center">
			                ...
			                <div className="details">
			                  ...
			                  <p>“I listed my Delhi apartment for rent and found a great tenant within a week. Highly recommend Plot!”</p>
			                  <h6>Rahul M., Delhi</h6>
			                  <div className="rating-inner">
			                    <i className="fas fa-star" />
			                    <i className="fas fa-star" />
